...
const Catalogo = () => {
    ...
    useEffect(()=>{
      if( producto === "tonala" || producto === "cuyutlan" || producto === "cajititlan" 
      || producto === "tapalpa" || producto === "tequila" || producto === "ocotlan"
      ){
        setProduts(`Caballeriza modelo ${producto}`);
      }

      if( producto === "bañaderos" || producto === "bebederos" || producto === "montureros" 
    ...
    const imagesCajititlan = [imgCajititilan1,imgCajititilan2,imgCajititilan3,imgCajititilan4];
    const imagesCuyutlan = [imgCoyutlan1,imgCoyutlan2,imgCoyutlan4];
    const imagesTonala = [imgTonala1,imgTonala2,imgTonala3,imgTonala4,imgTonala5];
    const imagesTapalpa = [imgTapalpa1,imgTapalpa2,imgTapalpa3,imgTapalpa4,imgTapalpa5,imgTapalpa7,imgTapalpa8,imgTapalpa9,imgTapalpa10,imgTapalpa11,imgTapalpa12,imgTapalpa13];
    const imgaesTequila = [imgTequila1,imgTequila2,imgTequila3,imgTequila4,imgTequila5,imgTequila6];
    const imagesOcotlan = [imgOcotlan1,imgOcotlan2,imgOcotlan3,imgOcotlan4,imgOcotlan5,imgOcotlan6];
    const imageBebederos = [imgBebedero1,imgBebedero2,imgBebedero3,imgBebedero4,imgBebedero5,imgBebedero6,imgBebedero7,imgBebedero8,imgBebedero9,imgBebedero10,imgBebedero11,imgBebedero12,imgBebedero13];
    const imagesBañaderos = [imgBañadero1,imgBañadero2,imgBañadero3,imgBañadero4,imgBañadero5,imgBañadero6,imgBañadero7,imgBañadero8,imgBañadero9,imgBañadero10];
   ...
   <Div2>
     {
       ...
       {
         producto === "tonala" &&
         imagesTonala.map((img,index)=> <Img key={index} src={img} alt={`Caballeriza ${producto} ${index}`} />)
       }
       {
         producto === "ocotlan" &&
         imagesOcotlan.map((img,index)=> <Img key={index} src={img} alt={`Caballeriza ${producto} ${index}`} />)
       }
       {
         producto === "cajititlan" &&
         imagesCajititlan.map((img,index)=> <Img key={index} src={img} alt={`Caballeriza ${producto} ${index}`} />)
       }
       {
         producto === "cuyutlan" &&
         imagesCuyutlan.map((img,index)=> <Img key={index} src={img} alt={`Caballeriza ${producto} ${index}`} />)
       }
       {
         producto === "tapalpa" &&
         imagesTapalpa.map((img,index)=> <Img key={index} src={img} alt={`Caballeriza ${producto} ${index}`} />)
       }
       {
         producto === "tequila" &&
         imgaesTequila.map((img,index)=> <Img key={index} src={img} alt={`Caballeriza ${producto} ${index}`} />)
       }
       
       {
         producto === "montureros" &&
         imagesMontureros.map((img,index)=> <Img key={index} src={img} alt={`Caballeriza ${producto} ${index}`} />)
       }
       
       {
         producto === "bebederos" &&
         imageBebederos.map((img,index)=> <Img key={index} src={img} alt={`Caballeriza ${producto} ${index}`} />)
       }

       {
         producto === "bañaderos" &&
         imagesBañaderos.map((img,index)=> <Img key={index} src={img} alt={`Caballeriza ${producto} ${index}`} />)
       }
